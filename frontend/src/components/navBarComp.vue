<template>
    <header class="d-flex flex-wrap align-items-center justify-content-center justify-content-md-between border-bottom sticky-top">
      ...
      <ul class="nav col-12 col-md-auto mb-2 justify-content-center mb-md-0">
        ...
        <li><router-link to="/admin" class="nav-link px-2 link-dark"><img width="30" height="30" src="https://i.postimg.cc/k46xrK4B/admin-panel.png" alt="admin"></router-link></li>
                ...
                <li><router-link to="/cart" class="nav-link px-2 link-dark"><img width="30" height="30" src="https://i.postimg.cc/k46xrK4B/admin-panel.png" alt="cart"></router-link></li>
